 ...
 * @author adam
 */
public class Wans extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Thanks for playing!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Wans.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
